...
BULWARK_BUILDITEMS = [
    ...
    [50,   "Razorwire",            "Land_Razorwire_F",			0,   3],
    ...
    [125,  "Sandbag Round",        "Land_BagFence_Round_F",           180, 1.5],
    ...
    [1250, "Fireescape Tall",      "Land_FireEscape_01_tall_F",         0,   1],
    [2500, "Static HMG",           "B_HMG_01_high_F",                   0,   1],
    [3000, "Small Bunker",         "Land_BagBunker_Small_F",          180,   3],
    [3750, "H Barrier Tower",      "Land_HBarrierTower_F",            180,   4],
    ...
    [12000, "Cargo Tower",         "Land_Cargo_Tower_V4_F",             0,  12],
    [13500, "Modular Bunker HQ",   "Land_Bunker_01_HQ_F",               0,   8],
    [15000, "Pillbox Bunker Big",  "Land_PillboxBunker_01_big_F",       0,   8],
    [17000, "Modular Bunker Big",  "Land_Bunker_01_big_F",            180,   6],
    [20000, "Mod. Bunker big&tall","Land_Bunker_01_tall_F",           180,   7]
];
